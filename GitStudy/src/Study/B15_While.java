...
public class B15_While {
	...
	public static void main(String[] args) {
		...
		// while문은 증가값의 위치에 따라 결과가 달라질수있다 
		i =0 ; //초기화안하면 실행이 안됨! 
		while(i++ < 10) {
		...
		Scanner sc2 = new Scanner("1234 1588 1541 111 222 3333 4444 555");
		
		// hasNext(메서드) : 문장을 가져오는 메서드이다 
		// Scanner.hasNext() - 다음 값이 있으면 true 업으면 false
		
		while( sc1.hasNext()) {
			//Scanner.next() - 다음 하나의 값을 String 타입을 꺼낸다 
