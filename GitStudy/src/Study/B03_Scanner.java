...
public class B03_Scanner {
   ...
   /*
          ...
          - 어디에서 입력을 받을지 결정한 뒤에 다양한 값들을 입력 받을수 있다 
   ...
   public static void main(String[] args) {
      ...
      // - 다음으로 꺼낼 값이 아무것도 없을때는 입력을 계속 기다린다 
      System.out.print("이번에는 실수를 입력해주세요(정수도가능)");
      double b = sc. nextDouble();
      System.out.println("두번째로 입력하신 값은 : " + b + " 입니다 .");
      
      System.out.println("첫번째 값 * 두번째 값은 : " + (a*b) + " 입니다 .");
   }
