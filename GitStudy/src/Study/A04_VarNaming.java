...
public class A04_VarNaming {
   ...
   public static void main(String[] args) {
      ...
      /*
          ...
          (2) 두 단어 이상을 이어 붙인 변수명을 사용할때 대문자를 활용한다 (camelCase)
              ex ) appleCount , minsuAge , sujinGrade
              
          (3) 변수명 첫 글자는 소문자를 사용한다
           
          (4) 클라스명 첫 글자는 대문자를 사용한다
          
          (5) 프로그램 내에서 값이 변한지 않은 변수(상수)는 모두 대문자를 사용한다 
          ...
          (1) 변수의 첫 번째 글자는 숫자가 될 수 없다
              ex) 1st , 2nd ,4pple
          (2) 변수 명 사이에는 공백을 사용 할수 없다 
          
          (3) 특수문자는 _와 $만 사용할수 있다 
          
          (4) 이미 자바에서 사용하고 있는 키워드는 변수명으로 사용할 수 없다 
          (Eclipse에서는 이미 사용하고 있는 키워드를 보라색으로 보여준다)
           ex) byte , float ,double , int , final , public , static ...
       */
