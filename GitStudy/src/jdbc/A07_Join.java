...
public class A07_Join {
	...
	public static void main(String[] args) {
		...
		// 이름에 en이 들어가는 모든 사원의 이름 /고용일/부서번호 /부서명/도시를  모델을 이용해 
		// 저장한후 출력 
			...
			)
		{
			...
			while(rs.next()) {
				...
				// java.sql.Date.to java.util.Date -> Date to Instant -> Instant to LocalDateTime 
				
				Employee2 e = new Employee2(rs.getString("first_name"),rs.getDate("hire_date"),rs.getInt("department_id"),rs.getString("department_name"),rs.getString("city"));
