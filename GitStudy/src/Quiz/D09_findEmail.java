...
public class D09_findEmail {
	...
	/*
	 		이메일을 판별할수있는 정규표현식을 작성하고 테스트해보세요 
	 		
	 */
	
	public static void main(String[] args) {
		
		// 다음 문자열에서 이메일만 골라서 ArrayList에 차곡차곡 정리한후 한번씩 출력해보기 
		// 제대로 된 이메일이 몇개인지도 세보
		...
		String text = "조선일보	가정/육아	박은주	zeeny@chosun.com\r\n"
		  ...
		  int count = 0;
	      Matcher seung_email = Pattern.compile("[\\w]+@[\\w&&\\D]+[.]*[\\w]*[.]*[\\w]*").matcher(text); // 승운
	      Matcher teacher_email = Pattern.compile("[\\w]+@[\\w]+\\.(com|net|co.kr)").matcher(text);  // 강사

	      ArrayList<String> emails = new ArrayList<>();
	      
	      while (teacher_email.find()) {
	         emails.add(teacher_email.group());
	         System.out.println(teacher_email.group());
	         count++;
	      }
